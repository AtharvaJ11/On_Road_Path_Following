...
path_publisher = rospy.Publisher("/pathTopicName", Path, queue_size=10)
dummy_publisher = rospy.Publisher("/dummy__pathTopicName", Point_ROS, queue_size=10)
i = 0
r = rospy.Rate(1) #1hz
while rospy.is_shutdown is not True:
    i+=1
    rospy.loginfo("Path published [%d]",i)
    ##do some stuff
    ...
    r.sleep()
    ## dummy.publisher.publish(objectOfThisTypeOfPublisher(here Point_ROS))
